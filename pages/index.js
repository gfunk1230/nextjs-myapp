...
const Home = () => (
  <div className="portfolio-app">
    ...
    <div className="container">
        ...
        <div className="list-group">
          <a href="#" className="list-group-item list-group-item-action flex-column align-items-start py-3 subtle-shadow no-border">
            ...
            <div className="avatar-container my-2">
              ...
              <span className="avatar-title">Greg Campoverde</span>
            </div>
          </a>
      ...
      <section className="gc-topic-list">
                      ...
                      <div className="topic-header">
                        <div className="topic-meta">
                          <div className="name-container">
                            <span className="name">Greg Campoverde</span>
                          </div>
    ...
    <div className='reply-controls'>
      <div className="reply-area">
        ...
        <div className="gc-editor">
          <div className="gc-editor-textarea-wrapper">
            <textarea
              name="content"
              placeholder="Type here">
            </textarea>
          </div>
          <div className="gc-editor-preview-wrapper">
